...
class AllItemScreen2 extends StatefulWidget {
  final String selectedStatus;
  var initialIndex = 0;
  bool navigatedFromNavBar;

  AllItemScreen2({Key? key, this.selectedStatus = 'All', this.navigatedFromNavBar = false}) : super(key: key);

  @override
  State<AllItemScreen2> createState() => _AllItemScreen2State();
}

class _AllItemScreen2State extends State<AllItemScreen2> {
...
// class AllItemScreen2 extends GetView<AllItemController> {
//   AllItemScreen2({super.key});
//
//   AllItemController allItemsController = Get.put(AllItemController());
//
//
