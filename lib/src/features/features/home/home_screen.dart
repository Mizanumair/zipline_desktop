    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          ...
          Center(child: CustomText(text: strService, color1: AppColors.white, fontWeight: fontWeight600, fontSize: font_19)),
          CustomDivider(
          height: height_40,
          ),
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    width: 150,
                    child: CustomText(text: 'Recent Orders', color1: AppColors.white, fontWeight: fontWeight600, fontSize: font_19),
                  ),
                  CustomDivider(
                    width: 700,
                  ),
