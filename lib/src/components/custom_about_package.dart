  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppColors.textWhite.withOpacity(.05),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    CustomText(text: text, color1: AppColors.textWhite, fontWeight: fontWeight500, fontSize: font_12, textAlign: TextAlign.start),
                    Container(
