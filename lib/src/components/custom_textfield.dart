        ...
        children: [
          TextFormField(
           // textAlignVertical: TextAlignVertical.center,
            ...
            obscureText: obscure,
            validator: validator,
            style: TextStyle(color: AppColors.orange, fontSize: 13, fontWeight: fontWeight400, ),
            decoration: InputDecoration(
              alignLabelWithHint: true,
              filled: true,
              fillColor: color ?? AppColors.white.withOpacity(.1),
              label: Text(labelText, textAlign: TextAlign.center),
              labelStyle: TextStyle(color: AppColors.textWhite,fontSize: 14, fontFamily: 'Mukta', fontWeight: fontWeight400,),
